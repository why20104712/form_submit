...
public class HttpClietDemo {
    ...
    public void postForm() {
        ...
        // 创建httppost
        HttpPost httppost = new HttpPost("http://localhost:8080/uploadController/postForm");
        // 创建参数队列
    ...
    public void post() {
        ...
        CloseableHttpClient httpclient = HttpClients.createDefault();
        // 创建httppost
        HttpPost httppost = new HttpPost("http://localhost:8080/controller/upload");
        // 创建参数队列
        List<NameValuePair> formparams = new ArrayList<NameValuePair>();
...
//            HttpEntity reqEntity = MultipartEntityBuilder.create().addBinaryBody("file", new FileInputStream(bin.getFile())).build();
