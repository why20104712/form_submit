...
public class UploadController {
    ...
    public String postFrom(Model model, String username, String password) {
    ...
    /**
     * springmvc自带的上传功能，将表单的文件对象封装成multipartFile
     * @param multipartFile
     * @return
     */
    ...
    public String upload1(MultipartFile multipartFile) {
        ...
        try {
            ...
            File file = new File("E:" + File.separator + "demo" + File.separator + "upload.jpg");
    ...
    public String upload(HttpServletRequest request, HttpServletResponse response, Model model)  {
        ...
        try{
            ...
            try {
                ...
                //            request.getRequestDispatcher("/message.jsp").forward(request, response);
                model.addAttribute("message","上传文件的总的大小超出限制的最大值！！！");
                return "message";
